...
# задаем координаты королевы  в формате c4
Q_c, Q_r = input()
Q_r = n - int(Q_r)
Q_c = ord(Q_c) - 97
...
# расставляем возможные ходы для королевы
for i in range(8):
    for j in range(8):
        if i==Q_r or j==Q_c or j==i+Q_c-Q_r or j==Q_c+Q_r-i:
            desk[i][j] = '*'

# ставим королеву на поле
desk[Q_r][Q_c] = 'Q'
